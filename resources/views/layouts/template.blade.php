...
<html lang="en">
<head>
    <title>@yield('title', 'Juarisco Shop')</title>
    <meta charset="utf-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                        <div class="product home_item_large">
                                                            ...
                                                            <div class="product_image"><img src="{{ asset('assets/images/home_2.jpg') }}" alt=""></div>
                                                            <div class="product_content">
                                                                <div class="product_buttons">
                                                                    <div class="text-right d-flex flex-row align-items-start justify-content-start">
                                                                        <div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                                                                            <div><div><img src="{{ asset('assets/images/cart_2.svg') }}" alt=""><div>+</div></div></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="col-lg-4 footer_col">
                    <div class="footer_about">
                        <div class="footer_logo">
                            <a href="#">
                                <div class="d-flex flex-row align-items-center justify-content-start">
                                    <div class="footer_logo_icon"><img src="{{ asset('assets/images/logo_2.png') }}" alt=""></div>
                                    <div>Jhonatan Shop</div>
                                </div>
                            </a>
                        </div>
